...
module.exports = function(connection){
    ...
    queries.push({
        ...
        values: [
            ['2015-08-10 22:50:30', '2015-08-10 22:50:38', 1, 'admin@admin.com', 'Admin', 'Admin', 1, null],
    ...
    queries.push({
        ...
        values: [
            ['local', UserPassport.encryptSync('password'), null, null, null, null, null, 2, 1, '2015-08-10 22:50:30', '2015-08-10 22:50:30'],
            ['local', UserPassport.encryptSync('password'), null, null, null, null, null, 1, 2, '2015-08-10 22:50:30', '2015-08-10 22:50:30'],
        ]
    });
